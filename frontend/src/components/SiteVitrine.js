...
import { Gamepad2, Trophy, Star, Zap, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50">
      <header className="sticky top-0 z-20 border-b border-white/60 bg-white/70 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link
            to="/login"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg"
          >
            Sign in
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          >
            Quizzes, crosswords, AI simulation and multiplayer — learn German while having fun.
          </motion.p>
          ...
          >
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3.5 font-semibold text-white shadow-lg hover:shadow-xl transition-all"
            >
              Get started free
